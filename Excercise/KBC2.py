...
sum =0
for i in ques:
    print (i)    #logic will be same as KBC 1 just i am directly printed i as it is now belong to string not int
    if i==q1:    # in this question actually we cannot use match case as match case only works with int not with str that's why we are using if elif here
